...
<div class="modal">
    <div class="lista-produto-modal bg-branco animate__animated animate__flipInX">
        ...
        <table class="zebra wd-100 collapse" id="tabela">
            <thead>
                <tr>
                    <th class="txt-c t">Imagem</th>
                    <th class="txt-c t">Código</th>
                    <th class="txt-c n">Nome</th>
                     <th class="txt-c t">Estoque</th>
                    <th class="txt-c t">Preço</th>
            ...
            <tbody>
                ...
                ?>
                        ...
                        <tr>
                            <td width="60" class="txt-e"><img class="logo-40" src="/lib/img/upload/produtos/<?= $produto->IMAGEM; ?>" alt=""></td>
