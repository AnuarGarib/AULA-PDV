...
<div class="modal">
    <div class="lista-cliente-modal bg-branco  animate__animated animate__flipInX">
        ...
        <table class="zebra wd-100 collapse" id="tabela">
            <thead>
                <tr>                    
                    ...
                    <th class="fonte12 espaco-letra fw-bold d">Cpf</th>
                    ...
                    <th class="fonte12 espaco-letra fw-bold d">Status</th>
                    <th class="fonte12 espaco-letra fw-bold d">Data Cadastro</th>
                    <th class="fonte12 espaco-letra fw-bold t">Açoes</th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                        <tr class="tr">
                            ...
                            <td class="fonte12 espaco-letra fw-300 txt-e"><?= $formater->formataTextoCap($cliente->NOME); ?></td>
                            <td class="fonte12 espaco-letra fw-300 txt-c"><?= $formater->formataTextoCap($cliente->CPF); ?></td>
                            <td class="fonte12 espaco-letra fw-300 txt-e"><?= $formater->formataTextoCap($cliente->LOGRADOURO); ?></td>
                            <td class="fonte12 espaco-letra fw-300 txt-e"><?= $formater->formataTextoCap($cliente->BAIRRO); ?></td>
                            <td class="fonte12 espaco-letra fw-300 txt-e"><?= $formater->formataTextoCap($cliente->CIDADE); ?></td>
                            <td class=" txt-c">
